...
def prepare_ds(preprocess_fn, batch_size, ds, cache=True):
...
def get_simple_image_ds(d_cfg: Dataset):
    ...
    train_dataset = prepare_ds(preprocess, bs, train_dataset, cache=d_cfg.cache)
    val_dataset = prepare_ds(preprocess, bs, val_dataset, cache=d_cfg.cache)
    test_dataset = prepare_ds(preprocess, bs, test_dataset, cache=d_cfg.cache)
